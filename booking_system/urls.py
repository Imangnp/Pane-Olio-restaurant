...
urlpatterns = [
    ...
    path('list_reservations/',
         views.list_reservations, name='list_reservations'),
    ...
    path('cancel_reservation_msg/<int:reservation_id>/',
         views.cancel_reservation_msg, name='cancel_reservation_msg'),
    path('edit_reservation/<int:reservation_id>/',
         views.edit_reservation, name='edit_reservation'),
    path('edit_reservation_success/',
         views.edit_reservation, name='edit_reservation_success')
]
